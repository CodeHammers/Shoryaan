...
export class Eligibility extends React.Component {
    ...
    render() {
        const content1 = this.state.question1
            ...
            <View>
                <Text style={{ color: 'red', fontSize: 16 }}>
                    { this.state.languages.includes('ar') ?  I18n.t('You cannot donate at this time However we would be delighted to see you when you are 18'): 'You cannot donate at this time However we would be delighted to see you when you are 18'}
                </Text>
            </View>
            : null;
        const content2 = this.state.question2
            ...
            <View>
                <Text style={{ color: 'red', fontSize: 16 }}>
                    {  this.state.languages.includes('ar') ? 
            ...
            <View>
                <Text style={{ color: 'red', fontSize: 16 }}>
                    {this.state.languages.includes('ar') ? 
                        ...
                        'If you are a female under 26 years of age and are less than 168cms in height and less than 65 kgs your height and weight will need to be assessed to establish your eligibility to donate'}
                </Text>
            </View>
            : null;
                            ...
                            <CardItem>
                                ...
                                <View style={{ flex: 5 }}>
                                    ...
                                    <Text style={styles.question}>
                                        { this.state.languages.includes('ar') ?  I18n.t('Are you under 18?') : 'Are you under 18?'}
                                    </Text>
                        ...
                        <Card style={{ marginTop: -2 }}>
                            ...
                            <CardItem>
                                ...
                                <View style={{ flex: 5 }}>
                                    ...
                                    <Text style={styles.question}>
                                        { this.state.languages.includes('ar') ?  I18n.t('Are you 65 years of age or over?') : 'Are you 65 years of age or over?'}
                                    </Text>
                        ...
                        <Card style={{ marginTop: -2 }}>
                            ...
                            <CardItem>
                                ...
                                <View style={{ flex: 5 }}>
                                    ...
                                    <Text style={styles.question}>
                                        { this.state.languages.includes('ar') ?  I18n.t('Do you weigh less 50kgs or more than 130kgs?') : 'Do you weigh less 50kgs or more than 130kgs?'}
                                    </Text>
                        ...
                        <Card style={{ marginTop: -2 }}>
                            ...
                            <CardItem>
                                ...
                                <View style={{ flex: 5 }}>
                                    ...
                                    <Text style={styles.question}>
                                        { this.state.languages.includes('ar') ?  I18n.t('For women are you under 26 years of age?') : 'For women are you under 26 years of age?'}
                                    </Text>
                                    ...
                                    <Text style={styles.question}>
                                        {
                                          this.state.languages.includes('ar') ?   
                                            ...
                                            :'Today or in the last 2 weeks have you had any illness or injury eg a cough a cold a sore throat vomiting diarrhoea or an open wound?'}
                                    </Text>
                            ...
                            <CardItem>
                                ...
                                <View style={{ flex: 5 }}>
                                    ...
                                    <Text style={styles.question}>
                                        ...
                                        :'For women are you pregnant or have you been pregnant in the past 12 months?'}
                                    </Text>
